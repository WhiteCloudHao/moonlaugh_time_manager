...
import com.falcom.manager.meeting.api.dto.response.TagResponse;
import com.falcom.manager.meeting.persistence.noti.Notification;
import com.falcom.manager.meeting.service.NotiService;
import com.falcom.manager.meeting.service.TagService;
...
public class TagController {
    ...
    @GetMapping(path = "/list", produces = MediaType.APPLICATION_JSON_VALUE)
        ...
        List<com.falcom.manager.meeting.persistence.tag.Tag> tagList = tagService.getListTag();
