...
import com.moonlaugh.manager.meeting.api.dto.AuthenticationRequest;
...
import com.moonlaugh.manager.meeting.service.EmailService;
import com.moonlaugh.manager.meeting.untils.ConstantMessages;
import com.moonlaugh.manager.meeting.untils.ValidateEmail;
...
//                                    break;
    ...
    public ResponseEntity<Object> verifyCode(@RequestBody VerifyCodeRequest verifyCodeRequest) {
        ...
        try {
            ...
            return new ResponseEntity<>(err.getReason(), HttpStatus.BAD_REQUEST);
        }
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
